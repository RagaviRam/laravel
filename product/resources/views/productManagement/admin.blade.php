    ...
    <div class="row content">
      <div class="col-sm-2 sidenav">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li class="active"><a href="{{route('product/admin_dashboard')}}">Admin</a></li>
          <li><a href="{{route('product/manager_dashboard')}}">Manager</a></li>
          <li><a href="{{route('product/customer_dashboard')}}">Customer</a></li>
        ...
        <div class="col-sm-8 text-center">
          ...
          <div class="col-sm-15 text-center">
            ...
            <div class="input-group-append">
              ...
              <button class="btn btn-outline-secondary" type="button">List</button>
            </div>
            <div class="col-sm-15 text-center">
